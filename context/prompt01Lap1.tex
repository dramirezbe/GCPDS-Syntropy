...
All summaries, pseudocode, and observations must be embedded as string
values within the JSON structure. 
Do NOT output prose, tables, commentary, or markdown.
Do NOT wrap the JSON in markdown code fences (e.g., ```json).
Return ONLY the raw JSON object.

CONTEXT-WINDOW RULE:
If the notebook exceeds 3000 lines of dense code, you MUST respond with
...
- Include the exact code snippet and cell-relative line range (e.g., Lines 4-12).
